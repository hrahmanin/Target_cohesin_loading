...
LEF_births = [0.0001, 0.0002, 0.0005, 0.001, 0.005, 0.01, 0.05, 0.1]
target_site_nums = [1]
delta_list = [ 4, 8, 10, 20, 40,  80, 100,  200, 400,  800, 1000] 
    ...
    for lifetime in lifetimes:
        for velocity_multiplier in velocities:
            for lef_birth in LEF_births:
                for target_site_num in target_site_nums:
                                    ...
                                    for CTCF_lifetime in CTCF_lifetimes:
                                        for CTCF_offtime in CTCF_offtimes:
                                            paramset = (
                                                ...
                                                '_targetsnum_'+str(target_site_num)+
